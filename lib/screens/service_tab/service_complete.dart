...
import 'package:estheva_doctor/screens/detail/complete_service_appointment.dart';
import 'package:estheva_doctor/uitls/colors.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class ServiceComplete extends StatefulWidget {
  final Map<String, dynamic> userData;

  const ServiceComplete({super.key, required this.userData});

  @override
  State<ServiceComplete> createState() => _ServiceCompleteState();
}

class _ServiceCompleteState extends State<ServiceComplete> {
  @override
