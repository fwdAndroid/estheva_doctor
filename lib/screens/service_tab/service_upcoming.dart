...
import 'package:estheva_doctor/screens/detail/service_appointment_detail.dart';
import 'package:estheva_doctor/uitls/colors.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class ServiceUpcoming extends StatefulWidget {
  final Map<String, dynamic> userData;

  const ServiceUpcoming({super.key, required this.userData});

  @override
  State<ServiceUpcoming> createState() => _ServiceUpcomingState();
}

class _ServiceUpcomingState extends State<ServiceUpcoming> {
  @override
