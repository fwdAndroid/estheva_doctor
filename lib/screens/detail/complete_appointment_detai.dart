...
class CompleteAppointmentDetais extends StatefulWidget {
  ...
  const CompleteAppointmentDetais({
    super.key,
  ...
  @override
  State<CompleteAppointmentDetais> createState() =>
      _CompleteAppointmentDetaisState();
}

class _CompleteAppointmentDetaisState extends State<CompleteAppointmentDetais> {
  @override
